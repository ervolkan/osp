...
için draft deposit bekliyor. **~1149 workspace test (osp-desktop hariç; osp-core 652 lib, osp-cli 155 unit + 21 review_flow + 20 supersede_flow + 12 preview_flow + 13 analyze_bridge_flow + 9 resolution_flow + 2 architecture_guards, osp-mcp +2 INV-C11), 0 development marker, 367 kelime abstract.**
...
- 652 osp-core lib testi, 13 golden fixture + **5 held-out adversarial** (4 held_out + 1 regression_anchored)
