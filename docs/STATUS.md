...
için draft deposit bekliyor. **~887 workspace test (osp-desktop hariç, CLI: osp-core 538 lib, osp-cli 36 unit + 21 review_flow + 20 supersede_flow + 10 preview_flow, osp-mcp +2 INV-C11), 0 development marker, 367 kelime abstract.**
...
- osp-llm-runtime: ~12
- osp-cli: 36 unit (store_io/repository/seed_file/review_session/mapper/preview-builder) + 21 review_flow + 20 supersede_flow + 10 preview_flow integration
