...
| **Operator review testleri** | osp-core lib 637 (PR G: 603→637 +34: ConceptPacketId Ord/round-trip + DerivedEdgeReference/Lineage/Expectation nested public ctor + ResolvedImplementationBasis + project_resolved_implementations pure projector fail-closed + RP1-RP4 lineage fold tests); osp-cli 155 unit (PR G untouched) + 21 review_flow + 20 supersede_flow + 12 preview_flow + 13 analyze_bridge_flow + 9 resolution_flow + 2 architecture_guards integration; osp-mcp +2 INV-C11 |
