...
| **Operator review testleri** | osp-core lib 595 (PR F: 588→595 +7: ResolvedCodeIdentity + InMemoryCodeEvidenceSource builders + ResolvedCodeEvidenceProvider adapter + EI5-b footgun guard); osp-cli 150 unit (PR F migration: evidence_projection test'leri adapter pattern'e geçti, sayı korundu) + 21 review_flow + 20 supersede_flow + 12 preview_flow + 13 analyze_bridge_flow + 9 resolution_flow + 2 architecture_guards integration; osp-mcp +2 INV-C11 |
